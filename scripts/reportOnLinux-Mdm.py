...
def completeChecksMdm(env, serverList, propertiesDict, bApplyRequiredChanges):
    ...
    for servername in serverList :
        ...
        auditingLibrary.auditObjectAtoms.append(auditingLibrary.auditObjectAtomCompleteAnAction(servername, runtimeProperties["username"], runtimeProperties["identityFileFullPath"], runtimeProperties["identityFilePassword"], 'JVM Mem Opts', 'source ~/.bash_profile; grep -ia \'Xmx\' \'/opt/install/EAP-6.4.0/bin/standalone.conf\''))
